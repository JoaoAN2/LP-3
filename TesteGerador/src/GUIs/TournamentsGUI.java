...
import javax.swing.JComboBox;
 ...
 /**
 * @author JoaoAN2 10/10/2022 - 23:59:19
 */
    ...
    public TournamentsGUI() {
        ...
        btnSearch.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                tournaments = daoTournaments.obter(((Tournament) cbTournament.getSelectedItem()).getIdTournament());
                tournaments = daoTournaments.obter(((Player) cbPlayer.getSelectedItem()).getIdPlayer());
                tournaments = daoTournaments.obter(Integer.valueOf(tfTournamentsIdTournament.getText()));
                ...
                if (tournaments != null) {
                    ...
                    cbPlayer.setSelectedItem(tournaments.getTournamentsIdPlayer());
                    tfPositionPlayer.setText(String.valueOf(tournaments.getPositionPlayer()));
       ...
       btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                tournaments.setTournamentsIdTournament(((Tournament) cbTournament.getSelectedItem()).getIdTournament());
                tournaments.setTournamentsIdPlayer(((Player) cbPlayer.getSelectedItem()).getIdPlayer());
                tournaments.setPositionPlayer(Integer.valueOf(tfPositionPlayer.getText()));
